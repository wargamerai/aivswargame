...
const AirCombatRL = {
    ...
    getTable: function() {
        if (!this._table) {
            // aircombat_q_data.js で定義された window.AIRCOMBAT_Q_TABLE から読み込み
            if (window.AIRCOMBAT_Q_TABLE) {
                this._table = window.AIRCOMBAT_Q_TABLE;
                console.log('[Q] AIRCOMBAT_Q_TABLE loaded:', Object.keys(this._table).length, 'states');
            } else {
                this._table = {};
            }
        }
